  ...
  <div class="container">
   ...
   <div class="row">
        <div id="eventTemplate" style="display: none">
            <div class="col-3 event card" style="width: 18rem; margin: 20px;">
                <img src="/img/logo.png" class="card-img-top" alt="Event #1">
                <div class="card-body">
                    <h3 class="evTitle card-title">Friday Service (Event #1)</h3>
